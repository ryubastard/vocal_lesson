        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->can('manager-higher') && !Auth::user()->can('admin'))
                        <x-nav-link href="{{ route('lessons.index') }}" :active="request()->routeIs('lessons.index')">
                            レッスン管理
                        </x-nav-link>

                        <x-nav-link href="{{ route('information.show') }}" :active="request()->routeIs('information.show')">
                            information管理
                        </x-nav-link>
                    @endcan
...
<div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
        ...
        @if (Auth::user()->can('manager-higher') && !Auth::user()->can('admin'))
            ...
            <x-responsive-nav-link href="{{ route('information.show') }}" :active="request()->routeIs('information.show')">
                information管理
            </x-responsive-nav-link>
        @endcan
